    ...
    public class DisputasController : Controller
    {
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscarPersonagens = "http://gustavoleite.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://gustavoleite.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://gustavoleite.somee.com/RpgApi/Disputas/DisputaEmGrupo";
